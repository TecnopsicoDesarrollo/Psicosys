...
@section('content_header')
    <h1>Crear Historia de Cabecera</h1>
@stop
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Create Salud Histocab</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('salud-histocab.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
...
@section('js')
    ...
    <script>
        //carga datos de contrato de la eps seleccionada
